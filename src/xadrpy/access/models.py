...
class Property(models.Model):
    ...
    namespace = NullCharField(max_length=128, db_index=True, verbose_name=_("Namespace"), editable=False)
    key = NullCharField(max_length=128, db_index=True, verbose_name=_("Key"), editable=False)
